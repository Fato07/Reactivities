...
namespace Application.Activities
{
    public class UnAttend
    {
        ...
        public class Handler : IRequestHandler<Attend.Command>
        {
            ...
            public async Task<Unit> Handle(Attend.Command request, CancellationToken cancellationToken)
            {
                ...
                { 
                    throw new RestException(HttpStatusCode.BadRequest, 
                        new{ Attendace = "You cannot Remove yourself as Host" });
                }
